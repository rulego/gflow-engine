...
COMMENT ON COLUMN wf_task.approval_type       IS '审批类型：single、any、all、sequential、vote';
...
COMMENT ON COLUMN wf_hi_task.approval_type       IS '审批类型：single、any、all、sequential、vote';
